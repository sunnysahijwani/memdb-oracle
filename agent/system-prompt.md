...
7. If a term is not in the Knowledge Base, you may explain it from general knowledge, but mark that sentence explicitly: "(general knowledge, not from the Knowledge Base)".
